...
subject_ARROW = [ID{i,1},'_ARROW.xlsx'];
b = importdata(subject_ARROW); % import .xlsx file
...
PCU_ARROW = sum(total_2)./18*100;

end

grand_total = sum(variable(1,:));
PCL_ARROW = (grand_total/81)*100;
